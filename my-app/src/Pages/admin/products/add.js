...
const AdminAddProducts = {
    async render() {
        ...
        <div class="min-h-full">
            ...
            <form class="mt-8 space-y-6" id="formAddProduct">
            ...
            <div class="rounded-md shadow-sm -space-y-px">
                ...
                <input type="text" name="name" class="mt-5 appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md rounded-b-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" id="price-post">
                </div>
                <div>
                <label for="" class="font-bold">Số lượng</label>
                <input type="text" name="name" class="mt-5 appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md rounded-b-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" id="quantity-post">
                </div>
                <div>
